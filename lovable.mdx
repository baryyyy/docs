...
<Danger>
  חשוב מאוד שכל הקריאות שאתם מבצעים למערכת שלנו, חייבות להיות לא חשופות לצד הלקוח על מנת לשמור על תהליך התשלום שלכם מאובטח. בLovable ניתן לעשות זאת באמצעות פיצר שנקרא Backend Function.
</Danger>
