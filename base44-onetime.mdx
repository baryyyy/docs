---
title: "חיובים חד-פעמיים (One-Time Payments) - Base44"
...
כל הפונקציות ההתממשקות והאינטגרציה עם SPLITZ מתבצעת דרך חבילת הNPM ולא בשום פנים ואופן בצורה ישירה לAPI!
...
**הפרמטר שייחזור בURL ששמו: order_uid יעזור לכם לזההות את ההזמנה ולאמת את התשלום.**

**לדוגמא: **[**https://example.com/subscriptionCallback?order_uid**](https://example.com/subscriptionCallback?order_uid)**=xxx**
